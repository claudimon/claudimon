...
C_SRCS    = src/kernel.c src/vga.c src/keyboard.c src/keyboard_layouts.c src/shell.c src/fs.c src/speaker.c src/theme.c src/editor.c src/disk.c src/power.c
C_OBJS    = $(C_SRCS:.c=.o)
